...
```yaml
  image: restyled/restyler-cabal-fmt:v0.1.6
  command: ["cabal-fmt", "--inplace"]
  arguments: []
  include: ["**/*.cabal"]
  interpreters: []
```
...
- https://github.com/jaspervdj/cabal-fmt

[source]: https://github.com/restyled-io/restylers/blob/main/cabal-fmt/info.yaml
