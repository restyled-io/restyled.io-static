...
This [Restyler][source] operates on **Haskell**, and will run automatically

## Configuration

```yaml
  image: restyled/restyler-stylish-haskell:v0.14.3.0
  command: ["stylish-haskell", "--inplace"]
  arguments: []
  include: ["**/*.hs"]
  interpreters: []
```
...
[source]: https://github.com/restyled-io/restylers/blob/main/stylish-haskell/info.yaml
