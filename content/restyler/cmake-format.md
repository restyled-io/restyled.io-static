...
This [Restyler][source] operates on **CMake**, and will run automatically

## Configuration

```yaml
  image: restyled/restyler-cmake-format:0.6.13-1
  command: ["cmake-format", "--in-place"]
  arguments: []
  include: ["**/CMakeLists.txt", "**/*.cmake-format-test"]
  interpreters: []
```
...
[source]: https://github.com/restyled-io/restylers/blob/main/cmake-format/info.yaml
